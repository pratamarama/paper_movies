...
abstract class MovieRemoteDatasource {
  Future<ListResponseModel<MovieModel>?> getMovieList({Function(int, int)? onReceiveProgress});
}
...
class MovieRemoteDatasourceImpl implements MovieRemoteDatasource {
  ...
  @override
  Future<ListResponseModel<MovieModel>?> getMovieList({Function(int, int)? onReceiveProgress}) async {
    final Response<Map<String, dynamic>> response = await _apiService.getMovieList();
