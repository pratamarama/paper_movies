...
abstract class ApiService {
  Future<Response<Map<String, dynamic>>> getMovieList({Function(int, int)? onReceiveProgress});
}
...
class ApiServiceImpl implements ApiService {
  ...
  @override
  Future<Response<Map<String, dynamic>>> getMovieList({Function(int, int)? onReceiveProgress}) async {
